 ...
 * `ev` fires. */
export declare function useEvent<E>(ev: EventEmitter<E>, f: (_: E) => void, dependencies?: React.DependencyList): void;
/**
...
export declare function useEventResult<E>(ev: EventEmitter<E>): E | undefined;
export declare function useEventResult<E, T>(ev: EventEmitter<E>, f: (newVal: E) => T): T | undefined;
...
export declare function useLogicalDom(ref: React.RefObject<HTMLElement>): [LogicalDomElement, LogicalDomStorage];
/**
