...
export type Expr<T> = AnnoFloat<T> | StringLit<T> | BoolLit<T> | ColorLit<T> | Path<T> | CompApp<T> | ObjFn<T> | ConstrFn<T> | BinOp<T> | UOp<T> | List<T> | Tuple<T> | Vector<T> | GPIDecl<T> | Layering<T>;
