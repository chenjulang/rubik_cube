...
import { BindingForm, BinOp, ColorLit, Expr, GPIDecl, LayoutStages, Path, UOp } from "./style";
...
export type SubstanceError = ParseError | DuplicateName | TypeNotFound | TypeVarNotFound | TypeMismatch | ArgLengthMismatch | TypeArgLengthMismatch | VarNotFound | DeconstructNonconstructor | UnexpectedExprForNestedPred | FatalError;
